...
import { signup, getAdmin, getOne, update, deleteAdmin, AdminEarnings, getAdminsBySuperAgent, superAdminAdmin15DayReport, companyAdmin15DayReport, getAllAdmins } from "../controller/admin.controller";
