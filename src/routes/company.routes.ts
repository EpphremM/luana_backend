...
import { companyEarnings, deleteCompany, getCompanies, getOneCompany, signup, topUpForAdmins, topUpForSuperAgents, updateCompany } from "../controller/company.controller";
